      ...
      <BodyWrapper style={{ padding: 24 }}>
        <AutoColumn gap="16px">
          <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
            ...
            <div>
              <QuestionHelper text={<Trans>Migrate your liquidity tokens from Swap V2 to Swap V3.</Trans>} />
            </div>
          </AutoRow>

          <ThemedText.DeprecatedBody style={{ marginBottom: 8, fontWeight: 485 }}>
            <Trans>
              For each pool shown below, click migrate to remove your liquidity from Swap V2 and deposit it into Swap
              V3.
            </Trans>
