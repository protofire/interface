  ...
  return useMemo(() => {
    ...
    Object.values(fonts).forEach((fontFamily) => {
      if (typeof fontFamily === 'string') {
        ...
        if (fontName && !fontSet.has(fontName)) {
          fontSet.add(fontName)
          fontMap.set(fontName, fontFamily)
        }
      }
    })
    ...
    if ((theme as any).text?.heading?.fontFamily) {
      ...
      if (typeof headingFontFamily === 'string') {
        ...
        if (headingFont && !fontSet.has(headingFont)) {
          fontSet.add(headingFont)
          fontMap.set(headingFont, headingFontFamily)
        }
      }
    }
