...
export const UNIVERSE_CHAIN_INFO: Record<UniverseChainId, UniverseChainInfo> = {
  ...
  [UniverseChainId.BaseSepolia]: {
    ...
    sdkId: UniswapSDKChainId.BASE_SEPOLIA,
    ...
    elementName: ElementName.ChainBaseSepolia, // Base Sepolia specific element
    explorer: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://info.testing.swap.w3us.site',
    infuraPrefix: undefined,
    ...
    rpcUrls: {
      ...
      appOnly: { http: ['https://sepolia.base.org'] },
    },
