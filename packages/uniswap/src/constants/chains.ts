...
export const UNIVERSE_CHAIN_INFO: Record<UniverseChainId, UniverseChainInfo> = {
  ...
  [UniswapSDKChainId.STABLE_TESTNET]: {
    ...
    statusPage: undefined,
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDT0_STABLE_TESTNET, 1e6),
    stablecoins: [USDT0_STABLE_TESTNET],
    supportsClientSideRouting: false,
    supportsGasEstimates: false,
    wrappedNativeCurrency: {
      name: 'Wrapped USD₮0',
  ...
  [UniswapSDKChainId.STABLE]: {
    ...
    urlParam: 'stable',
    statusPage: undefined,
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDT0_STABLE, 1e6),
