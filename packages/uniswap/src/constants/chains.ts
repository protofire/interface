...
export const UNIVERSE_CHAIN_INFO: Record<UniverseChainId, UniverseChainInfo> = {
  ...
  [UniverseChainId.Zircuit]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://v2-info.staging.zircuit-swap.w3us.site/',
    infuraPrefix: undefined,
    ...
    pendingTransactionsRetryOptions: undefined,
    rpcUrls: {
      [RPCType.Public]: { http: ['https://mainnet.zircuit.com'] },
      default: { http: ['https://mainnet.zircuit.com'] },
      appOnly: { http: ['https://mainnet.zircuit.com'] },
    },
