...
export const UNIVERSE_CHAIN_INFO: Record<UniverseChainId, UniverseChainInfo> = {
  ...
  [UniverseChainId.CyberTestnet]: {
    id: UniverseChainId.CyberTestnet,
    testnet: true,
    sdkId: UniswapSDKChainId.CYBER_TESTNET,
    assetRepoNetworkName: undefined,
    backendChain: {
    ...
    blockPerMainnetEpochForChainId: 1,
    blockWaitMsBeforeWarning: undefined,
    elementName: ElementName.ChainCyberTestnet,
    explorer: {
      name: 'Cyber Explorer',
      url: 'https://explorer.testnet.cyber.co/',
    },
    infoLink: 'https://app.uniswap.org/explore',
    infuraPrefix: undefined,
    interfaceName: 'cyber_testnet',
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_CYBER_TESTNET, 10_000e6),
    stablecoins: [USDC_CYBER_TESTNET],
  },
