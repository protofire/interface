...
import { EllipsisIcon, GithubIconMenu, PoolIcon, TelegramIconMenu, TwitterIconMenu } from 'nft/components/icons'
        ...
        {isOpen && (
          <NavDropdown top={{ sm: 'unset', lg: '56' }} bottom={{ sm: '50', lg: 'unset' }}>
            <Column gap="16">
              ...
              <IconRow>
                <Icon href="https://t.me/protofiresupport">
                  <TelegramIconMenu
                ...
                <Icon href="https://twitter.com/harmonyprotocol">
                  <TwitterIconMenu
                    className={styles.hover}
                    width={24}
                    height={24}
                ...
                <Icon href="https://github.com/harmony-one">
                  <GithubIconMenu
                    className={styles.hover}
                    width={24}
                    height={24}
