            ...
            <Suspense fallback={<Loader />}>
              {isLoaded ? (
                <Routes>
                  ...
                  <Route path="tokens" element={<Pool />} >
                    <Route path=":chainName" />
                  </Route>

                  <Route path="tokens/:chainName/:tokenAddress" element={<Pool />} />
...
{/* 
                  ...
                  {/* false in here to guarantee these paths don't become enabled */}
                  {false && !shouldDisableNFTRoutes && (
                    <>
                      <Route
                        path="/nfts"
                        element={
