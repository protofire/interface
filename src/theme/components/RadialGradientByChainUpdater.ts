    ...
    switch (chainId) {
      ...
      default: {
        ...
        const defaultLightGradient =
          ...
          'radial-gradient(100% 100% at 50% 0%, #00AEE9 0%, rgba(255, 255, 255, 0) 100%), rgb(255, 255, 255)'

        const defaultDarkGradient = 'linear-gradient(180deg, #202738 0%, #070816 100%)'
        backgroundRadialGradientElement.style.background = defaultLightGradient; // darkMode ? defaultDarkGradient : defaultLightGradient
      }
    }
